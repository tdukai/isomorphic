...
* @return {string} query value (undefined if not exists)
*/
Url.prototype.getQueryValue = function (name, url) {
    var result,
    values;
    url = (url === undefined) ? (typeof window !== 'undefined' ? window.location.href : '') : url;
    if (url) {
...
* @return {undefined}
*/
Url.prototype.setQueryValue = function (name, value, url) {
    url = (url === undefined) ? (typeof window !== 'undefined' ? window.location.href : '') : url;
...
* @return {string} url
*/
Url.prototype.host = function host (path) {
    var result = [
...
* @return {undefined} 
*/
Url.prototype.update = function update (values, url) {
    values = values || {};
